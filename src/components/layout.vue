  ...
  <div id="app" @click='resetComponent'>
    <div class="app-head">
      <div class="app-head-inner">
        <router-link :to="{path:'/'}">
          <img src="../assets/logo.png" alt="vue" title="vue">
        </router-link>

        <div class="head-nav">
          <ul class="nav-list">
            <li  @click='showDialog("isShowLog")' v-if="username== ''">登录</li>
            <li v-if="username !== ''">{{ username }}</li>
            <li class='nav-pile'>|</li>
            <li @click='showDialog("isShowReg")' v-if="username == ''">注册</li>
    ...
    <my-dialog :is-show='isShowLog' @on-close='closeDialog("isShowLog")'>
      <log-form @log-in='onSuccessLog'></log-form>
    </my-dialog>
    <my-dialog :is-show='isShowReg' @on-close='closeDialog("isShowReg")' >
      <reg-form @reg-in='onSuccessReg'></reg-form>
    </my-dialog>
...
export default {
  ...
  methods:{
    ...
    onSuccessReg(username){
      this.closeDialog ('isShowReg');
      this.username=username;
    },
    quitLog(){
      this.username=''
