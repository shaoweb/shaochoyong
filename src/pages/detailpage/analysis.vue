      ...
      <div class="sales-board-form">
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                <v-counter @on-change="onParamChange('buyNumber',$event)" :max='max'></v-counter>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
...
<script>
import VCounter from '../../components/basic/counter.vue'
...
export default {
  ...
  methods:{
    ...
    getPrice () {
      ...
      this.price = this.buyNumber*100+this.buyType.value*5+this.period.value*10+count
    },
    hidePayDialog(){
